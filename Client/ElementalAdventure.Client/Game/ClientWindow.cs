...
public class ClientWindow : GameWindow {
    ...
    private void LoadHandler() {
        try {
            ...
            _context.AssetManager.Add("null", new TileType("textureatlas.dungeon", "null", 0, 0.0f));
            _context.AssetManager.Add("floor_1", new TileType("textureatlas.dungeon", "floor_1", 0, 0.0f));
            _context.AssetManager.Add("floor_1_bottomhalf", new TileType("textureatlas.dungeon", "floor_1_bottomhalf", 0, 0.0f));
            _context.AssetManager.Add("floor_1_lefthalf", new TileType("textureatlas.dungeon", "floor_1_lefthalf", 0, 0.0f));
            _context.AssetManager.Add("floor_1_righthalf", new TileType("textureatlas.dungeon", "floor_1_righthalf", 0, 0.0f));
            _context.AssetManager.Add("floor_1_tophalf", new TileType("textureatlas.dungeon", "floor_1_tophalf", 0, 0.0f));
            _context.AssetManager.Add("floor_2", new TileType("textureatlas.dungeon", "floor_2", 0, 0.0f));
            _context.AssetManager.Add("floor_2_bottomhalf", new TileType("textureatlas.dungeon", "floor_2_bottomhalf", 0, 0.0f));
            _context.AssetManager.Add("floor_2_lefthalf", new TileType("textureatlas.dungeon", "floor_2_lefthalf", 0, 0.0f));
            _context.AssetManager.Add("floor_2_righthalf", new TileType("textureatlas.dungeon", "floor_2_righthalf", 0, 0.0f));
            _context.AssetManager.Add("floor_2_tophalf", new TileType("textureatlas.dungeon", "floor_2_tophalf", 0, 0.0f));
            _context.AssetManager.Add("wall_bottom", new TileType("textureatlas.dungeon", "wall_bottom", 0, 0.0f));
            _context.AssetManager.Add("wall_left", new TileType("textureatlas.dungeon", "wall_left", 0, 0.0f));
            _context.AssetManager.Add("wall_right", new TileType("textureatlas.dungeon", "wall_right", 0, 0.0f));
            _context.AssetManager.Add("wall_top", new TileType("textureatlas.dungeon", "wall_top", 0, 0.0f));
            _context.AssetManager.Add("wall_bottomleft_inner", new TileType("textureatlas.dungeon", "wall_bottomleft_inner", 0, 0.0f));
            _context.AssetManager.Add("wall_bottomright_inner", new TileType("textureatlas.dungeon", "wall_bottomright_inner", 0, 0.0f));
            _context.AssetManager.Add("wall_topleft_inner", new TileType("textureatlas.dungeon", "wall_topleft_inner", 0, 0.0f));
            _context.AssetManager.Add("wall_topright_inner", new TileType("textureatlas.dungeon", "wall_topright_inner", 0, 0.0f));
            _context.AssetManager.Add("wall_bottomleft_outer", new TileType("textureatlas.dungeon", "wall_bottomleft_outer", 0, 0.0f));
            _context.AssetManager.Add("wall_bottomright_outer", new TileType("textureatlas.dungeon", "wall_bottomright_outer", 0, 0.0f));
            _context.AssetManager.Add("wall_topleft_outer", new TileType("textureatlas.dungeon", "wall_topleft_outer", 0, 0.0f));
            _context.AssetManager.Add("wall_topright_outer", new TileType("textureatlas.dungeon", "wall_topright_outer", 0, 0.0f));
            _context.AssetManager.Add("fountain_1_bottom", new TileType("textureatlas.dungeon", "fountain_1_bottom", 0, 7.0f / 32.0f));
            _context.AssetManager.Add("fountain_1_top", new TileType("textureatlas.dungeon", "fountain_1_top", -1, -1.0f - 7.0f / 32.0f));
            _context.AssetManager.Add("fountain_2_bottom", new TileType("textureatlas.dungeon", "fountain_2_bottom", 0, 7.0f / 32.0f));
            _context.AssetManager.Add("fountain_2_top", new TileType("textureatlas.dungeon", "fountain_2_top", -1, -1.0f - 7.0f / 32.0f));

            _context.AssetManager.Add("mage", new PlayerType("textureatlas.player", "mage_idle_left", "mage_idle_right", "mage_walk_left", "mage_walk_right", 0, 2.0f / 32.0f, 0.25f));
            _context.AssetManager.Add("slime", new EnemyType("textureatlas.enemy", "slime_walk_left", "slime_walk_right", "slime_walk_left", "slime_walk_right", 0, 2.0f / 32.0f, 0.125f));
        } catch (Exception e) {
