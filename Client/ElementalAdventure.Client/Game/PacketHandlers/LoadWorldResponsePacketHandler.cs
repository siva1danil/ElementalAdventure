...
public class LoadWorldResponsePacketHandler : PacketRegistry.IPacketHandler {
    ...
    public void Handle(PacketConnection connection, IPacket ipacket) {
        ...
        _context.CommandQueue.Enqueue(new SetTilemapCommand(tilemap, walls, packet.Midground, new Vector2(packet.PlayerPosition.Item1, packet.PlayerPosition.Item2)));
    }
}