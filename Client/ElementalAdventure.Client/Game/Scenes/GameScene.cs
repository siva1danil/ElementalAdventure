...
public class GameScene : IScene, IUniformProvider {
    ...
    public void SpawnEnemy(EnemyType enemyType, Vector2 position) {
        Entity enemy = new Entity(_context.AssetManager, new LivingDataComponent(false, true, enemyType.MaxHealth, enemyType.MaxHealth, enemyType.Speed), null, new HitboxDataComponent(new Box2(-0.01f, -0.5f + 2.0f / 32.0f - 0.01f, 0.01f, -0.5f + 2.0f / 32.0f + 0.01f)), [new EnemyBehaviourComponent(enemyType)]);
