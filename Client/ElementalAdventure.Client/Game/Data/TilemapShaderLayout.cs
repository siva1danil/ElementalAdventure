...
public static class TilemapShaderLayout {
    ...
    public struct InstanceData(Vector3 positionLast, Vector3 positionCurrent, int index, Vector2i frameSize, int frameCount, int frameTime) {
    ...
    public struct UniformData(Matrix4 projection, Vector2i timeMilliseconds, float alpha, Vector2i textureSize, Vector2i cellSize, int padding) {
        ...
        [FieldOffset(88)] public Vector2i CellSize = cellSize;
